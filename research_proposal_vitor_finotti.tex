...
\begin{resumo}
     % Contextualization
     Convolutional neural networks have played a prominent role in recent years in the fields of computational vision, becoming the dominant approach for almost all recognition and detection tasks.
     % Gap
...
\begin{resumo}[Resumo]
  \begin{otherlanguage*}{brazil}
    % Contextualization
    Redes neurais convolucionais têm tido um papel de destaque nos últimos anos nos campos de visão computacional, sendo a abordagem mais usada para as tarefas de reconhecimento e detectação.
    % Gap
